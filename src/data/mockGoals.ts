...
//   - Mia Davis (no-show + cancellation today, 38% utilization): two goals
//     on "hold" with stale data plus one "discontinued" — the attendance
//     gap and goal stagnation are the same problem surfacing twice.
//   - Liam Anderson (red zone in auth, 87%): intensive treatment; one goal
//     on "hold" (regression) and one "discontinued" (clinically deprioritised).
//   - Sophia Bennett (red zone, 92%): all in-progress, fresh data (1-2 days) —
//     the "intense work, on track" client.
...
export const mockGoals: Record<string, Goal[]> = {
  "sophia-bennett": [
    ...
    { id: "g-sb-2", name: "Tacting common household objects",   masteryTarget: "90% accuracy across 5 sessions",            streakDays: 5, streakPercent: 88, lastUpdatedDaysAgo: 1, status: "in-progress"  },
  ...
  "liam-anderson": [
    { id: "g-la-1", name: "Independent toileting",              masteryTarget: "0 accidents for 5 consecutive sessions",    streakDays: 5, streakPercent: 100, lastUpdatedDaysAgo: 1, status: "in-progress"   },
    { id: "g-la-2", name: "Tolerating transitions",             masteryTarget: "<2 prompts on 5 transitions",               streakDays: 4, streakPercent: 80,  lastUpdatedDaysAgo: 1, status: "in-progress"   },
    ...
    { id: "g-la-4", name: "Greeting peers appropriately",       masteryTarget: "Independent in 4 of 5 opportunities",       streakDays: 0, streakPercent: 60,  lastUpdatedDaysAgo: 5, status: "hold"          },
    ...
    { id: "g-la-8", name: "Tooth brushing sequence",            masteryTarget: "90% accuracy on task analysis, 3 sessions", streakDays: 0, streakPercent: 60,  lastUpdatedDaysAgo: 9, status: "discontinued"  },
  ],
  ...
  "ethan-carter": [
    ...
    { id: "g-ec-5", name: "Sitting at table for 5 minutes",     masteryTarget: "5 minutes without prompts, 3 sessions",     streakDays: 0, streakPercent: 55, lastUpdatedDaysAgo: 4, status: "hold"          },
  ...
  "mia-davis": [
    { id: "g-md-1", name: "Tolerating transitions",             masteryTarget: "<2 prompts on 5 transitions",               streakDays: 0, streakPercent: 50, lastUpdatedDaysAgo: 6, status: "discontinued"  },
    { id: "g-md-2", name: "Manding for preferred items",        masteryTarget: "80% accuracy across 3 sessions",            streakDays: 0, streakPercent: 55, lastUpdatedDaysAgo: 5, status: "hold"          },
    { id: "g-md-3", name: "Eye contact during greetings",       masteryTarget: "4 of 5 trials across 3 sessions",           streakDays: 0, streakPercent: 48, lastUpdatedDaysAgo: 7, status: "hold"          },
  ...
  "lucas-hayes": [
    ...
    { id: "g-lh-4", name: "Independent toileting",              masteryTarget: "0 accidents for 5 consecutive sessions",    streakDays: 4, streakPercent: 90, lastUpdatedDaysAgo: 1, status: "in-progress"   },
