...
// StaffOverviewPage; certification dates drive CertificationsExpiringTile.
// Distribution notes:
...
//   - Certification expiries are intentionally varied so the expiring-soon
//     tile has data to render. As of May 13, 2026:
//       - Marcus Johnson (May 2026) is the urgent renewal (~18 days).
//       - James Rodriguez and Ben Garcia (Jul 2026) are warning-level
//         (~79 days each).
//     These three are deliberately NOT in the existing flagged trio so the
//     cert tile flags new people instead of piling on. Adds variety without
//     diluting the David/Olivia/Tyler narrative.
...
export const mockStaff: Staff[] = [
  ...
  { name: "Marcus Johnson",   totalHours: 40, directHours: 32, indirectHours:  5, cancellationHours:  3, role: "Technician", hireDate: "2022-04-10", certification: "RBT — expires May 2026",  team: "Team A" },
  ...
  { name: "James Rodriguez",  totalHours: 42, directHours: 34, indirectHours:  6, cancellationHours:  2, role: "Technician", hireDate: "2021-09-03", certification: "RBT — expires Jul 2026",  team: "Team B" },
  ...
  { name: "Ben Garcia",       totalHours: 41, directHours: 33, indirectHours:  5, cancellationHours:  3, role: "Technician", hireDate: "2022-11-15", certification: "RBT — expires Jul 2026",  team: "Team B" },
