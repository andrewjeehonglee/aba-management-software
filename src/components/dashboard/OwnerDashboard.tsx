...
const EMPTY_TILES: OwnerDashboardData["monitorTiles"] = [
  {
    ...
    summaryLines: [{ text: "Every note is in for this pay period." }],
  ...
  },
  {
    ...
    summaryLines: [{ text: "Every client is within authorized hours." }],
  ...
  },
  {
    ...
    summaryLines: [{ text: "Direct engagement is on track this month." }],
