...
const EMPTY_TILES: OwnerDashboardData["monitorTiles"] = [
  {
    ...
    title: "Session notes",
    state: "healthy",
    headerLine: "Every note is in for this pay period.",
    summaryLines: [{ text: "Every note is in for this pay period.", tone: "neutral" }],
    footerNote:
  ...
  },
  {
    ...
    state: "healthy",
    headerLine: "Every client is within authorized hours.",
    summaryLines: [{ text: "Every client is within authorized hours.", tone: "neutral" }],
  ...
  },
  {
    ...
    title: "Direct hours",
    state: "healthy",
    headerLine: "Direct engagement is on track this month.",
    summaryLines: [{ text: "Direct engagement is on track this month.", tone: "neutral" }],
    emptyLabel: "All clear — direct engagement on track this month",
    rows: [],
    viewAllRows: [],
    totalRowCount: 0,
    calmNote: "Direct ratios are monitored after the 21st of each month.",
  },
]
