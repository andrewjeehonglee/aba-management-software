...
export function OwnerNavRail({
  ...
  return (
    <>
      {/* Desktop rail */}
      <aside className="hidden min-h-0 w-[236px] shrink-0 flex-col border-r border-ink/10 bg-bg px-3 py-6 min-[1000px]:flex">
      ...
      <header className="flex min-h-0 shrink-0 items-center justify-between gap-3 border-b border-ink/10 bg-bg px-4 py-3 min-[1000px]:hidden">
