...
### Batch 1 — Cross-surface (`40f6d46`)
- Owner/non-owner dashboard terminology & payroll layout; clients sort toggle; staff grid density
- Start Session attempt #1 + `seed_demo_open_sessions.sql`

### Batch 2 (`76916a4`)
- Owner airier ranked rows; payroll compact centered; KPI dual-number session notes
- Start Session attempt #2 — split `getSessionById`, demo guard
...
| Hash | Message |
|------|---------|
| `40f6d46` | Polish dashboards, clients/staff layout, and Start Session flow |
| `76916a4` | Polish batch 2: airier owner tiles, KPI restructure, fix Start Session lookup |
| `96e5f74` | Polish batch 3: payroll, calendar chips, KPI tiles, demo new-session flow |
| `0bda487` | Shorten BCBA calendar, enlarge chips, center KPI popups |
| `81f223b` | Box-grid KPI popups with staff headers and session dates |
